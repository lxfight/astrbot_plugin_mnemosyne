...
def collection_schema_to_dict(schema: CollectionSchema) -> Dict[str, Any]:
    ...
    for field in schema.fields:
        ...
        elif field.dtype in [DataType.FLOAT_VECTOR, DataType.BINARY_VECTOR] and hasattr(field, 'params'):
            # 向量字段的维度信息在 params 中
...
def merge_schema_dicts(base_schema: Dict[str, Any], update_schema: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    result = {
        ...
        'description': update_schema.get('description', base_schema.get('description', ''))
    }
